...
\seealso{\code{\link[clusterSim]{data.Normalization}}, \code{\link[clusterSim]{interval_normalization}}, \code{\link[clusterSim]{dist.Symbolic}}, \code{\link[smacof]{smacofSym}}
}
\examples{
  \donttest{
 library(mdsOpt)
